...
class Net(nn.Module):
    def __init__(self):
        ...
        def encoderFunction():
            ...
            layer = [layerA(3, 16, activation="ReLU", kernel_size = 3, padding='same', stride=1),
                    layerA(16, 32, activation="ReLU", kernel_size = 3, padding='same', stride=1),
                    layerA(32, 64, activation="ReLU", kernel_size = 3, padding='same', stride=1),
                    layerA(64, 128, activation="ReLU", kernel_size = 3, padding='same', stride=1),
                    layerA(128, 256, activation="ReLU", kernel_size = 3, padding='same', stride=1)]
            return layer
